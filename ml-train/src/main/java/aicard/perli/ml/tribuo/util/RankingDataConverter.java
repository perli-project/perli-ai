package aicard.perli.ml.tribuo.util;
 ...
 *
 * <p>이 클래스는 서비스 레이어에서 가공된 {@link CardRequest} DTO 리스트를
 ...
 * @version 1.0
 */
public class RankingDataConverter {
     ...
     */
    public Dataset<Regressor> convertToDataset(List<CardRequest> requests) {
